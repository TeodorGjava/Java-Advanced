...
public class ControllerImpl implements Controller {
    ...
    public String addAnimal(String areaName, String animalType, String animalName, String kind, double price) {
        ...
        Area area = areas.get(areaName);
        boolean areLandAreaAndTypeMatch = area.getClass().getSimpleName().equals("LandArea") && animalType.equals("TerrestrialAnimal");
        boolean areWaterAreaAndTypeMatch = area.getClass().getSimpleName().equals("WaterArea") && animalType.equals("AquaticAnimal");

        if (areWaterAreaAndTypeMatch || areLandAreaAndTypeMatch) {
